...
const Explore3Screen = () => {
  ...
  return (
      <View style={styles.container}>
        ...
        <Text style={styles.largeText}>Cabin in the middle of the woods</Text>
        <Text style={styles.smallText}>Private Room in Peoria, Illinois</Text>
        <Text style={styles.houseInfoText}>4 guests - 2 bedrooms - 4 bed - 1 bathroom</Text>
        <View style={styles.ratingContainer}>
          <Ionicons name="star" size={18} color="#000000" style={styles.starIcon} />
          <Text style={styles.ratingText}>1.4 - 53 reviews</Text>
        </View>
        ...
        <View style={styles.hostContainer}>
          ...
          <View style={styles.hostInfoContainer}>
            <Text style={styles.hostText}>Hosted by Johnny</Text>
        ...
        <View style={styles.buttonContainer}>
          <Text style={styles.priceText}>$100 / night</Text>
